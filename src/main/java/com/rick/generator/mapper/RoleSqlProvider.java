...
import com.rick.generator.entity.RoleExample.Criteria;
import com.rick.generator.entity.RoleExample.Criterion;
...
public class RoleSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getRoleDesc() != null) {
            SET("role_desc = #{record.roleDesc,jdbcType=VARCHAR}");
        }
